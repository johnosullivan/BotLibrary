...
rolib.so: src/rolib.o src/core/rolibcore.o src/servo/rolibservo.o src/sensor/rolibsensor.o src/servo/servo.o src/gpio/rolibgpio.o src/servo/maestro/maestro.o src/gpio/gpio.o
		$(CC) $(SHARELIB_FLAGS) -o $(BIN)$@ $^
